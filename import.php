...
foreach ($fiches as $fiche) {
    ...
    // Sinon, on lance la création du bureau de vote
        ...
        $query = $link->prepare(
            'INSERT INTO `bureaux` (`bureau_code`, `canton_id`, `commune_id`, `circonscription_id`, `departement_id`, `bureau_nom`, `bureau_cp`)
    ...
    $query = $link->prepare(
        'INSERT INTO `contacts` (`immeuble_id`, `bureau_id`, `contact_nom`, `contact_nom_usage`, `contact_prenoms`, `contact_naissance_date`, `contact_naissance_commune_id`, `contact_sexe`, `contact_electeur`, `contact_electeur_europeen`, `contact_electeur_numero`) 
    ...
    $query = $link->prepare(
        'INSERT INTO `votes` (`contact_id`, `vote_election`, `vote_participation`) VALUES (:contact, "mun2008-1", :mun20081);
