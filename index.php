...
if (empty($_GET['page'])) {
    ...
    } elseif ($_GET['page'] == 'recherche-thematique') {
        Core::loadTemplate('recherche', 'thematique');
    } // Si on demande le module cartographique
    elseif ($_GET['page'] == 'carto') {
