...
/**
 * ON RÉALISE LE TRAITEMENT AUTOMATISÉ DE CHARGEMENT
 * DES TEMPLATES SELON LES PAGES APPELÉES
 */
...
if (isset($_GET['page'])) :
    ...
    elseif ($_GET['page'] == 'contacts') :
        ...
        // On regarde s'il s'agit d'une page particulière,
        // sinon on met l'accueil du module
        if (isset($_GET['fiche'])) :

            Core::loadTemplate('fiche');

            // Si aucune page précise n'a été demandée,
            // on affiche l'accueil du module
        else :
    ...
    elseif ($_GET['page'] == 'interaction') :
        ...
        if (isset($_GET['action'])) :
            ...
            if ($_GET['action'] == 'ajout') :
                ...
                // Sinon, on redirige vers le module contact,
                // vers une fiche si une fiche existait
         else :
    ...
    elseif ($_GET['page'] == 'boitage' || $_GET['page'] == 'porte') :
        ...
        } else if (isset($_GET['mission']) && isset($_GET['immeuble'])) {
...
// Une fois les templates chargés, on met en place la purge et
// on calcule le temps nécessaire au chargement de la page
// à des fins de statistique
