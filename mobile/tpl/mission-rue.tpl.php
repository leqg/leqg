...
?>
	...
	<ul class="listeImmeubles">
    	<?php
            ...
            ?>
        		<a class="nostyle" href="<?php Core::tpl_go_to('mission', array('code' => $_GET['code'], 'rue' => $_GET['rue'], 'immeuble' => $immeuble)); ?>">
	...
	<a href="<?php Core::tpl_go_to('mission', array('code' => $_GET['code'])); ?>" class="bouton nostyle">Retour à la mission</a>
