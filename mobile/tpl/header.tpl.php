...
<html lang="fr">
	...
	<body>
		...
		<header id="barreHaute">
			<h1><a href="<?php Core::goPage(); ?>" class="nostyle">LeQG</a></h1>
			<a id="goToMenu" href="#menu">&#xe811;</a>
		</header>
		
		<nav id="menu">
			<a href="<?php Core::goPage('recherche'); ?>"><span>&#xe803;</span>Recherche</a>
			<a href="<?php Core::goPage('contacts'); ?>"><span>&#xe840;</span>Contacts</a>
			<a href="<?php Core::goPage('porte'); ?>"><span>&#xe841;</span>Porte à porte</a>
			<a href="<?php Core::goPage('boitage'); ?>"><span>&#xe84d;</span>Boîtage</a>
			<a href="<?php Core::goPage('deconnexion'); ?>" onclick="return confirm('Êtes-vous sûr de vouloir vous déconnecter ?');"><span>&#xe85d;</span>Déconnexion</a>
		</nav>
