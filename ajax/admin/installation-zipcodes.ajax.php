<?php
/**
 * Installation de la liste des codes postaux d'après un CSV
 *
 * PHP version 5
 *
...
foreach ($data as $line) {
    ...
    if ($row == 0) {
        ...
        $query = 'INSERT INTO `codes_postaux` (`code_postal`,  `commune_id`) ';
        $query .= 'VALUES ('.$information['Codepos'].', '.$information['INSEE'].')';
