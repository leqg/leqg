<?php
	...
	$donnees['objet'] = $_POST['objet'];
	$donnees['notes'] = $_POST['notes'];

	// On lance l'enregistrement des données dans la base de données
	$enregistrement = $historique->ajout( $donnees['contact'] , $donnees['compte'] , $donnees['type'] , $donnees['date'] , $donnees['lieu'] , $donnees['objet'] , $donnees['notes'] );
