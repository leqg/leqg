<?php
    ...
    Core::loadHeader();
?>
	<a href="<?php Core::goTo('porte', array('action' => 'missions')); ?>" class="nostyle"><button class="gris" style="float: right; margin-top: 0em;">Interface militant</button></a>	
	<h2>Porte à porte</h2>
    ...
    <?php if ($missions) : ?>
        ...
        <?php endif; ?>
			...
			<a class="nostyle" href="<?php Core::goTo('porte', array('action' => 'nouveau')); ?>"><button>Créer une nouvelle mission</button></a>
		</section>
    <?php else : ?>
		<section class="icone" id="aucuneMission">
			<h3>Aucune mission lancée actuellement !</h3>
			<a class="nostyle" href="<?php Core::goTo('porte', array('action' => 'nouveau')); ?>"><button>Créer une mission</button></a>
		</section>
    <?php endif; ?>
