<?php
    ...
    Core::loadHeader();
?>
    <?php if (User::authLevel() >= 5) : ?><a href="<?php Core::goPage('boite'); ?>" class="nostyle"><button class="gris" style="float: right; margin-top: 0em;">Administration</button></a><?php 
    endif; ?>
	...
	<section id="missions">
        ...
        <?php foreach ($invitations as $invitation) : $mission = new Mission(md5($invitation)); ?>
    		<li>
    		    ...
    		    <p>Vous êtes invité à participer à cette mission par <em><?php echo User::getLoginByID($mission->get('responsable_id')); ?></em>.</p>
    		</li>
        <?php endforeach; ?>
    	</ul>
	</section>
