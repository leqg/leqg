...
<div class="colonne demi droite">
    <section class="contenu demi">
        ...
        <ul class="listeContacts">
            <a href="<?php Core::goTo('mission', array('code' => $data->get('mission_hash'), 'admin' => 'invitations')); ?>" class="nostyle"><li class="contact ajout">Inviter de nouveaux militants à la mission</li></a>
