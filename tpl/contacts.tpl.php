	...
	<div class="colonne demi gauche">
		<section class="contenu demi">
			<ul class="iconesActions">
				<a href="<?php Core::goPage('contact', array('operation' => 'creation')); ?>"><li class="new">Nouvelle fiche</li></a>
				<!--<a href="<?php Core::goPage('fiche', array('operation' => 'fusion')); ?>"><li class="merge">Fusion de fiches</li></a>-->
			</ul>
		</section>
