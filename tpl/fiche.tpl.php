	...
	<form action="#" method="post">
		<ul class="deuxColonnes">
			...
			<li>
				...
				<span class="icone-modification" id="modifierAdressePostale" title="Modifier l'adresse déclarée"><a href="<?php $core->tpl_go_to('fiche', array('id' => $_GET['id'])); ?>&modifierAdresse=true">&#xe855;</a></span>
			</li>
			<li>
