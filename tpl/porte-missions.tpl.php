<?php
	...
	Core::tpl_header();
?>
	<?php if (User::auth_level() >= 5) : ?><a href="<?php Core::tpl_go_to('porte'); ?>" class="nostyle"><button class="gris" style="float: right; margin-top: 0em;">Administration</button></a><?php endif; ?>
