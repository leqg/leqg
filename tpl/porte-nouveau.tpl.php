			...
			<ul class="deuxColonnes">
				...
				<li>
					...
					<ul class="listeEncadree">
						<a href="<?php $core->tpl_go_to('porte', array('action' => 'nouveau')); ?>" title="Retour au choix de la ville">
							<li class="ville">
				...
				<li>
					...
					<ul class="listeEncadree">
						<a href="<?php $core->tpl_go_to('porte', array('action' => 'nouveau', 'ville' => $_GET['ville'])); ?>" title="Retour au choix de la rue">
							<li class="rue">
