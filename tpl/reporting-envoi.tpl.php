...
if ($data->get('mission_type') == 'porte') {
    ...
    if (!count($coordonnees)) { Core::goPage('reporting', array('mission' => $_GET['mission'], 'rue' => $_GET['rue']), true); 
    }
}
...
<form action="<?php Core::goPage('reporting', array('action' => 'coordonnees', 'mission' => $_GET['mission'], 'rue' => $_GET['rue'])); ?>" method="post">
