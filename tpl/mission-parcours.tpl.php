...
<div class="colonne demi gauche">
    <section class="contenu demi">
        ...
        <ul class="form-liste" id="listeDesRues">
        	...
        	<li>
        		<?php if ($stats['proportion'] < 100) { ?><a href="<?php Core::goTo('reporting', array('mission' => $data->get('mission_hash'), 'rue' => $rue['id'])); ?>" class="nostyle"><button class="voirRue gris">Voir la fiche</button></a><?php } ?>
