...
?>
	...
	<div class="colonne demi gauche">
		<section class="contenu demi">
			<?php if ($campagne->get('campagne_type') == 'sms') : ?>
				<h4>SMS envoyé</h4>
			<?php else : ?>
				<h4>Email envoyé</h4>
			<?php endif; ?>
			...
			<?php 
				// Affichage du contenu dans le cadre d'un SMS
				if ($campagne->get('campagne_type') == 'sms') {
					echo '<p><em>' . $campagne->get('campagne_message') . '</em></p>';
				}
				
				// Affichage du contenu dans le cadre d'un Email
				else {
					echo $campagne->get('campagne_message');
				}
			?>
		</section>
