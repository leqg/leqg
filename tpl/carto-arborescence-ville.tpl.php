...
<section id="fiche" data-fiche="<?php echo $ville['id']; ?>">
	...
	<ul class="deuxColonnes">
		...
		<li>
			<span class="label-information">Électeurs</span><?php $nombre = $carto->nombreElecteurs('ville', $ville['id']); ?>
			<p><?php echo $nombre; ?> électeur<?php echo ($nombre > 1) ? 's' : ''; ?> connu<?php echo ($nombre > 1) ? 's' : ''; ?></p>
		</li>
		<li>
			<span class="label-information">Emails</span><?php $nombre = $carto->nombreElecteurs('ville', $ville['id'], 'email'); ?>
			<p><?php echo $nombre; ?> adresse<?php echo ($nombre > 1) ? 's' : ''; ?> d'électeur récoltée<?php echo ($nombre > 1) ? 's' : ''; ?></p>
		</li>
		<li>
			<span class="label-information">Téléphones mobiles</span><?php $nombre = $carto->nombreElecteurs('ville', $ville['id'], 'mobile'); ?>
			<p><?php echo $nombre; ?> numéro<?php echo ($nombre > 1) ? 's' : ''; ?> d'électeur récolté<?php echo ($nombre > 1) ? 's' : ''; ?></p>
		</li>
		<li>
			<span class="label-information">Téléphones fixes</span><?php $nombre = $carto->nombreElecteurs('ville', $ville['id'], 'telephone'); ?>
			<p><?php echo $nombre; ?> numéro<?php echo ($nombre > 1) ? 's' : ''; ?> d'électeur récolté<?php echo ($nombre > 1) ? 's' : ''; ?></p>
		</li>
	</ul>
</section>
<aside>
	<h6>Accéder aux informations les rues de <em><?php $carto->afficherVille($ville['id']); ?></em></h6>
