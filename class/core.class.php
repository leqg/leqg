...
class Core
{
    ...
    public static function tpl_header( $nom = null ) 
    {
        Core::tpl_load('header', $nom); 
    }
    ...
    public static function tpl_footer( $nom = null ) 
    {
        Core::tpl_load('footer', $nom); 
    }
    ...
    public static function tpl_aside( $nom = null ) 
    {
        $this->tpl_load('aside', $nom); 
    }
    ...
    public    function tpl_get_url( $page = null , $valeur = null , $attribut = null, $valeur2 = null, $attribut2 = null) 
    {
        echo $this->tpl_return_url($page, $valeur, $attribut, $valeur2, $attribut2); 
    }
    ...
    public    function tpl_get_domain() 
    {
        echo $this->tpl_return_domain(); 
    }
    ...
    public static function tpl_phone( $numero ) 
    {
        if (!empty($numero)) { echo $numero{0}.$numero{1}.' '.$numero{2}.$numero{3}.' '.$numero{4}.$numero{5}.' '.$numero{6}.$numero{7}.' '.$numero{8}.$numero{9}; 
        } 
    }
    ...
    public static function get_tpl_phone( $numero ) 
    {
        if (!empty($numero)) { return $numero{0}.$numero{1}.' '.$numero{2}.$numero{3}.' '.$numero{4}.$numero{5}.' '.$numero{6}.$numero{7}.' '.$numero{8}.$numero{9}; 
        } 
    }
