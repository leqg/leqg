...
class Dossier
{
     ...
     * @version 1.0
     *
     * @param string/array $dossier  Identifiant (hashage MD5) du dossier  demandé ou tableau des arguments de création  si c'est une création demandé ou tableau des arguments de création  si c'est une création
