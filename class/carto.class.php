...
class Carto
{
    ...
    public static function recherche_rue( $ville , $search = '' ) 
    {
        ...
        $query = $link->prepare('SELECT *, SHA2(`rue_id`, 256) AS `rue_code` FROM `rues` WHERE `commune_id` = :ville AND `rue_nom` LIKE :search ORDER BY `rue_nom` ASC LIMIT 0, 30');
    ...
    public static function afficherArrondissement( $id , $return = false ) 
    {
        ...
        if ($return) : return $arrondissement['nom']; else : echo $arrondissement['nom']; 
        endif;
    }
    ...
    public static function afficherCanton( $id , $return = false ) 
    {
        ...
        // On retourne le résultat demandé
        if ($return) : return $canton['nom']; else : echo $canton['nom']; 
        endif;
    }
    ...
    public static function afficherVille( $id , $return = false ) 
    {
        ...
        // On retourne le résultat demandé
        if ($return) : return $ville['commune_nom']; else : echo $ville['commune_nom']; 
        endif;
    }
    ...
    public static function afficherRue( $id , $return = false ) 
    {
        ...
        // On retourne le résultat demandé
        if ($return) : return $rue['rue_nom']; else : echo $rue['rue_nom']; 
        endif;
    }
    ...
    public static function afficherImmeuble( $id , $return = false ) 
    {
        ...
        // On retourne le résultat demandé
        if ($return) : return $immeuble['immeuble_numero']; else : echo $immeuble['immeuble_numero']; 
        endif;
    }
     ...
     * @param  bool $coordonnees Si true ne compte que les électeurs dont le système  connait des coordonnées connait des coordonnées
     ...
     * @param  string $coordonnees Permet de restreindre l'estimation aux électeurs dont  certaines coordonnées sont connues certaines coordonnées sont connues
